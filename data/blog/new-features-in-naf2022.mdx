---
title: 'New features in NAF 2022'
date: 2022-02-02T15:32:14Z
lastmod: '2021-03-01'
tags: ['naf', 'cms', 'guide']
draft: false
summary: 'An overview of the new features released in NAF.com 2022 - static site generation, content hub integration, frontmatter layout and more'
layout: PostSimple
bibliography: references-data.bib
canonicalUrl: https://tailwind-nextjs-starter-blog.vercel.app/blog/new-features-in-naf2022/
---

## Overview

A post on the new features introduced in NAF 2022. New features:
...
For example, the following frontmatter will display the authors given by `data/authors/default.md` and `data/authors/newsletter.md`

...
We use catch all routes to handle the routing and path creations.
...
- Internationalization (though it would be recommended to use [Built-in i8n routing](https://nextjs.org/docs/advanced-features/i18n-routing))
